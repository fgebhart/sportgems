...
fn _get_climb(
    ...
    math::_climb_formula(&gained_altitude, &duration)
}
...
pub fn update_sections_max_climb(
    ...
    if window_sec.distance <= (input_data.desired_distance as f64) * 1.01 {
        if window_sec.climb > max_climb_sec.target_value {
            ...
            max_climb_sec.target_value = window_sec.velocity;
        }
    }
}

pub fn specific_data_check(input_data: &gem_finder::InputData) -> Result<(), gem_finder::InputDataError> {
